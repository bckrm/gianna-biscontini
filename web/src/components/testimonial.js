...
export default function Testimonial({ data }) {
    ...
    return (
        <section className="container grid grid-cols-1 lg:grid-cols-12 lg:gap-x-16 mb-32 relative">
            <div className="w-1/2 lg:w-64 justify-self-center lg:max-w-full lg:absolute lg:top-0 lg:left-0 overflow-hidden rounded-full transform -translate-y-1/4 translate-y-[-50%]">
